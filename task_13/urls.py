...
urlpatterns = [
    ...
    path('movies/', views.added_movies, name="movies-list"),
    ...
    path('restaurants/favoriteslist/',views.favorite_restaurants ,name='favorite-restaurants'),
]
